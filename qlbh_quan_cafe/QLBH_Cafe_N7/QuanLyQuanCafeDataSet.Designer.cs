...
namespace QLBH_Cafe_N7 {
    ...
    public partial class QuanLyQuanCafeDataSet : global::System.Data.DataSet {
        ...
        public partial class TaiKhoanDataTable : global::System.Data.TypedTableBase<TaiKhoanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TaiKhoanRow AddTaiKhoanRow(string TenDN, string TenNV, string MK, int Loai) {
...
namespace QLBH_Cafe_N7.QuanLyQuanCafeDataSetTableAdapters {
    ...
    public partial class TaiKhoanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TaiKhoan] WHERE (([TenDN] = @Original_TenDN) AND ([TenNV] = @O" +
                "riginal_TenNV) AND ([MK] = @Original_MK) AND ([Loai] = @Original_Loai))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TaiKhoan] ([TenDN], [TenNV], [MK], [Loai]) VALUES (@TenDN, @Te" +
                "nNV, @MK, @Loai);\r\nSELECT TenDN, TenNV, MK, Loai FROM TaiKhoan WHERE (TenDN = @T" +
                "enDN)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TaiKhoan] SET [TenDN] = @TenDN, [TenNV] = @TenNV, [MK] = @MK, [Loai] = @Loai WHERE (([TenDN] = @Original_TenDN) AND ([TenNV] = @Original_TenNV) AND ([MK] = @Original_MK) AND ([Loai] = @Original_Loai));
SELECT TenDN, TenNV, MK, Loai FROM TaiKhoan WHERE (TenDN = @TenDN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TenDN, TenNV, MK, Loai FROM dbo.TaiKhoan";
        ...
        public virtual int Delete(string Original_TenDN, string Original_TenNV, string Original_MK, int Original_Loai) {
        ...
        public virtual int Insert(string TenDN, string TenNV, string MK, int Loai) {
            if ((TenDN == null)) {
        ...
        public virtual int Update(string TenDN, string TenNV, string MK, int Loai, string Original_TenDN, string Original_TenNV, string Original_MK, int Original_Loai) {
            if ((TenDN == null)) {
                throw new global::System.ArgumentNullException("TenDN");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenNV, string MK, int Loai, string Original_TenDN, string Original_TenNV, string Original_MK, int Original_Loai) {
            return this.Update(Original_TenDN, TenNV, MK, Loai, Original_TenDN, Original_TenNV, Original_MK, Original_Loai);
        }
    }
